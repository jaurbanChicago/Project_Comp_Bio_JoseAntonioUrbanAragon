...
The Markov chain model of genetic drift will be explained in the following [vignette](https://jaurbanchicago.github.io/docs/Genetic_Drift_Markov_Model.html).
...
1. Hamilton, M. B. (2008). Population genetics. John Wiley & Sons.

2. Hartl, D. L. (2020). A primer of population genetics and genomics. Oxford University Press.
